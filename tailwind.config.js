    ...
    theme: {
        ...
        extend: {
            colors: {
                ...
                'do-today': {
                    DEFAULT: 'hsl(var(--do-today))',
                    foreground: 'hsl(var(--do-today-foreground))'
                },
                'schedule-soon': {
                    DEFAULT: 'hsl(var(--schedule-soon))',
                    foreground: 'hsl(var(--schedule-soon-foreground))'
                },
                delegate: {
                    DEFAULT: 'hsl(var(--delegate))',
                    foreground: 'hsl(var(--delegate-foreground))'
                },
                'let-go': {
                    DEFAULT: 'hsl(var(--let-go))',
                    foreground: 'hsl(var(--let-go-foreground))'
                },
                'clarity-low': 'hsl(var(--clarity-low))',
                'clarity-medium': 'hsl(var(--clarity-medium))',
                'clarity-high': 'hsl(var(--clarity-high))',
                sidebar: {
